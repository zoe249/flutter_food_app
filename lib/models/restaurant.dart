  ...
  */
  ...
  String displayCartReceipt() {
    ...
    for (final cartItem in _cart) {
      receipt.writeln("${cartItem.quantiry} x ${cartItem.food.name} - ${_formatPrice(cartItem.food.price)}");
  ...
  // format double value info money
  String _formatPrice(double price) {
    return '\$${price.toStringAsFixed(2)}';
  }

  // format list of addons info a string summary
